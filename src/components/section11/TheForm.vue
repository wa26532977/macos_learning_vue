<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: error_found}">
      <label for="user-name">Your Name</label>
      <input id="user-name" name="user-name" type="text" v-model.trim="userName" @blur="validateInput"/>
      <p v-if="error_found">Please enter a valid name</p>
    </div>
...
export default {
  ...
  methods: {
    submitForm() {
      console.log(`User name: ${this.userName}, user age: ${this.userAge}`)
      this.userName = ''
